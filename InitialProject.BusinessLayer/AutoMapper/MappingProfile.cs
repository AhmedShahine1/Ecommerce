    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<RoleDTO, ApplicationRole>()
                ...
                .ForMember(a => a.Description, s => s.MapFrom(b => b.RoleDescription)).ReverseMap();
            //--------------------------------------------------------------------------------------------------------
            CreateMap<Paths, PathsModel>()
                .ForMember(a => a.Name, s => s.MapFrom(b => b.Name))
                .ForMember(a => a.Description, s => s.MapFrom(b => b.Description)).ReverseMap();
            //--------------------------------------------------------------------------------------------------------
            CreateMap<City, CityModel>()
                ...
                .ForMember(a => a.CountryEn, s => s.MapFrom(b => b.CountryEn)).ReverseMap();
            //--------------------------------------------------------------------------------------------------------
