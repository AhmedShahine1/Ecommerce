        ...
        class HubConnection {
            ...
            constructor(connection, logger, protocol, reconnectPolicy, serverTimeoutInMilliseconds, keepAliveIntervalInMilliseconds, statefulReconnectBufferSize) {
                ...
                this._freezeEventListener = () => {
                    this._logger.log(LogLevel.Warning, "The page is being frozen, this will likely lead to the connection being closed and messages being lost. For more information see the docs at https://learn.microsoft.com/aspnet/Ecommerce.Core/signalr/javascript-client#bsleep");
                };
                    ...
                    if (this._options.skipNegotiation) {
                        ...
                        do {
                            ...
                            if (negotiateResponse.ProtocolVersion) {
                                throw new Error("Detected a connection attempt to an ASP.NET SignalR Server. This client only supports connecting to an ASP.NET Ecommerce.Core SignalR Server. See https://aka.ms/signalr-Ecommerce.Core-differences for details.");
                            }
