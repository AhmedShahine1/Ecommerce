/* jquery.signalR.Ecommerce.Core.js */
/*global window:false */
/*!
...
(function ($, window, undefined) {
    var resources = {
        ...
        AspNet.CoreSignalrServer: "Detected a connection attempt to an ASP.NET Ecommerce.Core SignalR Server. This client only supports connecting to an ASP.NET SignalR Server. See https://aka.ms/signalr-Ecommerce.Core-differences for details.",
            ...
            connection._.negotiateRequest = function () {
                var res,
                    ...
                    callback = function (result) {
                        ...
                        // Check if the server is an ASP.NET Ecommerce.Core app
...
/*global window:false */
/// <reference path="jquery.signalR.Ecommerce.Core.js" />
